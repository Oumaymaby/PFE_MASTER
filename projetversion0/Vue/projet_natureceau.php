...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Projet avec Nature cours d'eau
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Nature DPH</span>
              <?php $b = new NatureCeau_Service();
                    $bb= $b->nbdbh();
                    foreach($bb as $row){
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Nature Non DPH</span>
              <?php $b = new NatureCeau_Service();
                    $bb= $b->nbdnonbh();
                    foreach($bb as $row){
                      echo '<span class="info-box-number">'.$row[0].'</span>';
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Nature ORMVA</span>
              <?php $b = new NatureCeau_Service();
                    $bb= $b->nbormva();
                    foreach($bb as $row){
                      echo '<span class="info-box-number">'.$row[0].'</span>';
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Nature Non ORMVA</span>
              <?php $b = new NatureCeau_Service();
                    $bb= $b->nbnonormva();
                    foreach($bb as $row){
                      echo '<span class="info-box-number">'.$row[0].'</span>';
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste des projets avec avec leur nature</h3>
        ...
        <div class="col-xs-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets avec Nature DPH</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
        ...
        <div class="col-xs-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets avec Nature non DPH</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
        ...
        <div class="col-xs-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets avec Nature ORMVA</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
        ...
        <div class="col-xs-6">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets avec Nature Non ORMVA</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
...
<script>
  $(function() {
    $('#example1').DataTable({
      ...
      // "sScrollX": '100%',
      "pageLength": 3,
      ajax: {url: "../data/data_prj_natureceau.php",type: 'POST',dataSrc: 'Data',dataType:'json'},
      columns: [{data:'nature'},{ data:'gid'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'},],
    });
   $('#example2').DataTable({
      "paging"   : true,
      "lengthChange": true,
      ...
      "sScrollX": '100%',
      "pageLength": 3,
      ajax: {url: "../data/data_prj_natdph.php",type: 'POST',dataSrc: 'Data'},
      columns: [{data:'nature'},{ data:'gid'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],
    });
    $('#example3').DataTable({
      "paging"   : true,
      ...
      "sScrollX": '100%',
      "pageLength": 3,
      ajax: {url: "http://localhost/projectpfe/data/data_prj_natnondph.php",type: 'POST',dataSrc: 'Data'},
      columns: [{data:'nature'},{ data:'gid'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],
    });
    $('#example4').DataTable({
      "paging"   : true,
      ...
      "sScrollX": '100%',
      "pageLength": 3,
      ajax: {url: "http://localhost/projectpfe/data/data_prj_nat_ormva.php",type: 'POST',dataSrc: 'Data'},
      columns: [{data:'nature'},{ data:'gid'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],
    });
    $('#example5').DataTable({
      "paging"   : true,
      ...
      "sScrollX": '100%',
      "pageLength": 3,
      ajax: {url: "http://localhost/projectpfe/data/data_prj_nat_nonormva.php",type: 'POST',dataSrc: 'Data'},
      columns: [{data:'nature'},{ data:'gid'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],
    });
  });
</script>
