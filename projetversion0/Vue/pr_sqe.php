        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets avec avis de SQE</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr> 
                        ...
                        <th>remarques bet assainissement</th>
                        <th>remarque sup sqe</th>
                        <th>date avis sqe</th>
                        <th>approuve par sqe</th>
                        <th>valide par sqe</th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
...
$(function () {
    $('#example1').DataTable({
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_sqe.php",type: 'POST',dataSrc: 'data'},
      columns: [{data:'avis'},{data:'id'},{ data:'numero_dossier'},{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'},{data:'remarque_bet_assainissement'},{data:'remarque_sup_sqe'},{data:'date_avis_sqe'},{data:'approuve_par_sqe'},{data:'valide_par_sqe'}],
    });

    $.ajax({
			url:"http://localhost/projectpfe/data/data_chart_sqe.php",
			type:"GET",
      data:'data',
      // dataType:"json",
      // dataSrc: 'data',
