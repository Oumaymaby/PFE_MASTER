        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets avec avis de SEPRE</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr> 
                        ...
                        <th>remarques bet besoin d'eau</th>
                        <th>remarque superieur sepre</th>
                        <th>date avis sepre</th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
...
$(function () {
    $('#example1').DataTable({
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_sepre.php",type: 'POST',dataSrc: 'data'},
      columns: [{data:'avis'},{data:'id'},{ data:'numero_dossier'},{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'},{data:'remarque_bet_besoin_eau'},{data:'remarques_sup_sepre'},{data:'date_avis_sepre'},],
    });

    $.ajax({
			url:"http://localhost/projectpfe/data/data_chart_sepre.php",
			type:"GET",
      data:'data',
      // dataType:"json",
      // dataSrc: 'data',
