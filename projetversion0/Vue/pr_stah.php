        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets avec avis de STAH</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr> 
                        ...
                        <th>remarque sup stah</th>
                        <th>date avis stah</th>
                        <th>valide par stah</th>
                        <th>approuve par stah</th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
...
$(function () {
    $('#example1').DataTable({
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_stah.php",type: 'POST',dataSrc: 'data'},
      columns: [{data:'avis'},{data:'id'},{ data:'numero_dossier'},{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'},{data:'remarque_sup_stah'},{data:'date_avis_stah'},{data:'valide_par_stah'},{data:'approuve_par_stah'}],
    });

    $.ajax({
			url:"http://localhost/projectpfe/data/data_chart_stah.php",
			type:"GET",
      data:'data',
      // dataType:"json",
      // dataSrc: 'data',
