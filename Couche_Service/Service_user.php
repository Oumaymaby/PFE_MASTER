...
require_once '../Couche_metier/User_Classe.php';
...
class User_Service{
	...
	function __construct()
 	...
 	function add($user)
 	{
 	 	...
 	 	if ($st->execute(array($user->getid_users(),$user->getusername(),$user->getpassword(),$user->getnom(),$user->getprenom(),$user->getdivision(),$user->getservice()))) 
		{
 	 	echo"entré";
 		}
 		else{
