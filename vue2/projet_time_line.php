...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" id="css-main" href="assets/css/timeline.css">
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o side-overlay-o side-scroll page-header-modern main-content-boxed">
            <!-- Side Overlay-->
                ...
                <div class="content">
                    <div class="wrapper">
                        ...
                        <section>
                            ...
                            <div class="details">
                            <span class="title">Avis ABHT</span>
                            <?php 
                                $b = new ABHT_Service();
                                $id=$_GET['id'];
                                $avis = $b->findById($id);
                                echo '<span>'.$avis->getdate_avis_abht().'</span>';
                                echo  '</div><p>'.$avis->getrem_bet_bes_eau().'</p>';
                                echo '<div class="bottom"><a href="#">'.$avis->getavis_abht().'</a><i>- '.$avis->getapprouve_par().'</i></div>;'
                            ?>
                        ...
                        <section>
                            ...
                            <div class="details">
                            <span class="title">Reamarque STAH</span>
                        ...
                        <section>
                            ...
                            <div class="details">
                            <span class="title">Remarque SGDPH</span>
                        ...
                        <section>
                            ...
                            <div class="details">
                            <span class="title">Remarque SEPRE</span>
                        ...
                        <section>
                            ...
                            <div class="details">
                            <span class="title">Remarque SQE</span>
