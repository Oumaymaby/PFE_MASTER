...
class ProjetInv
{
	private $id_pr,$num_oss,$com,$province,$maitre_ouv,$intitule_pr,$date_arr_abht,$date_arr_bet,$architecte,$titre_foncier,$supf,$type_projet,$etat_dossier,$geom,$douar_loc,$fond_doss,$date_comm,$catg,$surf_bat,$type_doss,$sepre,$sqe,$stah,$sgdph;
	function __construct($a,$b,$c,$d,$e,$f,$g,$h,$i,$j,$k,$l,$m,$n,$o,$p,$q,$r,$s,$t,$u,$v,$w,$x)
	{
		$this->id_pr = $a;
		$this->num_oss= $b;
		$this->num_archv =$n;
        $this->date_arr_abht=$c;
        $this->date_arr_bet=$d;
        $this->com=$e;
        $this->province=$f;
		$this->douar_loc=$o;
