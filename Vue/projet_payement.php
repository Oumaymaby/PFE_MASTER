...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Listes des Projets Payé et non payé  
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Projet Payé</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Projet non payé</span>
              <?php $b = new Projet_Service();
                    $bb= $b->nbnonpaye();
                    foreach($bb as $row){
                      echo '<span class="info-box-number">'.$row[0].'</span>';
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets payés</h3>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets payé</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
...
<script>
  $(function () {
    $('#example1').DataTable({
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "../data/data_prj_payement.php",type: 'POST'},
      columns: [{data:'payement'},{ data:'id'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],
    });
    $('#example2').DataTable({
      "paging"   : true,
      "lengthChange": true,
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_paymentoui.php",type: 'POST',dataSrc: 'data2'},
      columns: [{data1:'payement'},{ data1:'id'},{ data1: 'numero_dossier' },{ data1: 'commune' },{ data1: 'province' },{ data1: 'maitre_ouvrage' },{data1:'intitule_projet'}],
    });
  })
</script>
</body>
