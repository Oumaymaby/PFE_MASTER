        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets avec avis de l'ABHT</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
...
$(function () {
    $('#example1').DataTable({
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_abht.php",type: 'POST',dataSrc: 'data'},
      columns: [{data:'avis'},{data:'id'},{ data:'numero_dossier'},{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'},{data:'remarques_generales_bet'},{data:'date_avis_abht'},{data:'etabli_par'},{data:'approuve_par'}],
    });

    $.ajax({
			url:"http://localhost/projectpfe/data/data_chart_abht.php",
			type:"GET",
      data:'data',
      // dataType:"json",
      // dataSrc: 'data',
        ...
        // var color=[];
				...
				// {
				// 	number.push(data[count].number);
				// 	avis.push(data[count].avis);
        //   color.push(data[count].color);
				// }

        // // var myChart = new Chart(document.getElementById('pieChart'), {
        // //   type: 'doughnut',
        // //   data: {labels:avis,datasets:[{label:avis,backgroundColor:color,color:'#fff',data:number}]},
        // //   options: {responsive: true,legend:false}
        // // });
        // // var pieChartCanvas = $('#pieChart').get(0).getContext('2d')
        // // var pieChart       = new Chart(pieChartCanvas)
        // // var donutchart= pieChart.Doughnut(
        // //   { data:{labels:avis,datasets:[{label:avis,backgroundColor:color,color:'#fff',data:number}]},}
