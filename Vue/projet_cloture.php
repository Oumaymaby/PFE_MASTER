        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets cloturés</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<script>
  $(function () {
    $('#example1').DataTable({
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "../data/data_prj_cloture.php",type: 'POST'},
