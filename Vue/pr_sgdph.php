        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets avec avis de SGDPH</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                    <tr> 
                        ...
                        <th>Remarque bet protection inondations</th>
                        <th>remarque sup sgdph</th>
                        <th>Date avis sgdph</th>
                        <th>Valide par sgdph</th>
                        <th>Approuve par sgdph</th>
                    </tr>
                </thead>
                <tfoot>
                    <tr>
...
$(function () {
    $('#example1').DataTable({
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_sgdph.php",type: 'POST',dataSrc: 'data'},
      columns: [{data:'avis'},{data:'id'},{ data:'numero_dossier'},{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'},{data:'remarque_bet_protection_inondations'},{data:'remarque_sup_sgdph'},{data:'date_avis_sgdph'},{data:'valide_par_sgdph'},{data:'approuve_par_sgdph'}],
    });

    $.ajax({
			url:"http://localhost/projectpfe/data/data_chart_sgdph.php",
			type:"GET",
      data:'data',
      // dataType:"json",
      // dataSrc: 'data',
