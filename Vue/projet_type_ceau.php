...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Listes des Projets avec type de cours d'eau
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Projet Oued-Chaabat</span>
              <?php $b = new TypeCEau_Service();
                    $bb= $b->nboued();
                    foreach($bb as $row){
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Projet khettara</span>
              <?php $b = new TypeCEau_Service();
                    $bb= $b->nbkhett();
                    foreach($bb as $row){
                      echo '<span class="info-box-number">'.$row[0].'</span>';
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Projet Saguia-Mesref</span>
              <?php $b = new TypeCEau_Service();
                    $bb= $b->nbsaguia();
                    foreach($bb as $row){
                      echo '<span class="info-box-number">'.$row[0].'</span>';
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets de type de cours d'eau</h3>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets de type Oued/Chaabat</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Les projets de type de cours d'eau "Khettara"</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Les projets de type de cours d'eau "Saguia/Mesref"</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
...
<script>
  $(function () {
    $('#example1').DataTable({
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_type_ceau.php",type: 'POST',dataSrc:'data'},
      columns: [{data:'type_cours_eau'},{ data:'id'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],
    });
    $('#example2').DataTable({
      "paging"   : true,
      "lengthChange": true,
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_type_ceau_oued.php",type: 'POST',dataSrc: 'data'},
      columns: [{data:'type_cours_eau'},{ data:'id'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],   });
    $('#example3').DataTable({
      "paging"   : true,
      "lengthChange": true,
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_type_ceau_khettara.php",type: 'POST',dataSrc: 'data'},
      columns: [{data:'type_cours_eau'},{ data:'id'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],
    });
    $('#example4').DataTable({
      "paging"   : true,
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_type_ceau_saguia.php",type: 'POST',dataSrc: 'data'},
      columns: [{data:'type_cours_eau'},{ data:'id'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],
    });
  })
</script>
