...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Listes des Projets avec type de dossier
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Projet d'Invesstissment</span>
              <?php $b = new Type_Dossier_Service();
                    $bb= $b->nbprojet_inv();
                    foreach($bb as $row){
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Projet d'Equipement Publique</span>
              <?php $b = new Type_Dossier_Service();
                    $bb= $b->nbequipub();
                    foreach($bb as $row){
                      echo '<span class="info-box-number">'.$row[0].'</span>';
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste detaillée des projets avec type de dossier</h3>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Liste des Projets d'Investissement</h3>
              <div class="box-tools pull-right">
                  <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                  </button>
                  <div class="btn-group">
...
<script>
  $(function () {
    $('#example1').DataTable({
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "../data/data_prj_type_dossier.php",type: 'POST',dataSrc: 'Data'},
      columns: [{data:'typedossier'},{ data:'id'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],
    });
    $('#example2').DataTable({
      "paging"   : true,
      "lengthChange": true,
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_type_dossier_prinv.php",type: 'POST',dataSrc: 'Data'},
      columns: [{data:'typedossier'},{ data:'id'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],
    });
    $('#example3').DataTable({
      "paging"   : true,
      ...
      "scrollX": true,
      "sScrollX": '100%',
      ajax: {url: "http://localhost/projectpfe/data/data_prj_type_dossier_preqpub.php",type: 'POST',dataSrc: 'Data'},
      columns: [{data:'typedossier'},{ data:'id'},{ data: 'numero_dossier' },{ data: 'commune' },{ data: 'province' },{ data: 'maitre_ouvrage' },{data:'intitule_projet'}],
    });
  })
</script>
