...
class ABHT_Service{
    ...
    // pas besoin d'une fonction ajouter car on peux ajouter avec une modification 
 	// function add($cat)
 	// {
 	//  	$st =	$this->db->prepare('insert into prj_inv.avis_sepre (id_sepre,origine_aep,origine_autre,besoin_eau_domestique,besoin_eau_irrigation,remarque_bet_besoin_eau,remarques_sup_sepre,avis_sepre,date_avis_sepre,date_avis_bet_sepre,id_prj) values (?,?,?,?,?,?,?,?,?,?,?)');
