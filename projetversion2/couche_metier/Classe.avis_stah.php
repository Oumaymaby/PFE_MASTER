...
class STAH
{
	private $remarque_sup_stah,$avis_stah,$date_avis_stah,$valide_par_stah,$approuve_par_stah,$remarque_bet_prot_inn,$avis_abht_amen,$amena_prop,$superficie_bv,$date_avis_bet_stah,$id_prj;
	function __construct($b,$c,$d,$e,$f,$g,$h,$i,$j,$k)
	{
        // $this->id_pr = $a;
        $this->avis_stah=$b;
